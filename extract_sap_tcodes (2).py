...
def main():
    parser = argparse.ArgumentParser(
        description='Extract SAP Transaction Codes from Word documents into Excel.'
    )
    parser.add_argument(
        '--folder', '-f',
        required=True,
    ...
    parser.add_argument(
        '--output', '-o',
        default='SAP_Tcodes_Extract.xlsx',
        help='Output Excel filename (default: SAP_Tcodes_Extract.xlsx)'
    )
    ...
    tcode_data, others = scan_folder(args.folder)
    build_excel(tcode_data, others, args.output)
