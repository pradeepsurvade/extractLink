...
def top_cluster_keywords(km, vectorizer, cluster_id: int, n: int = 30) -> list:
    """Return top n meaningful process keywords for a cluster centroid."""
...
def main():
    ...
    cluster_names = {i: make_group_name(cluster_kws[i], clean_texts, i) for i in range(n_clusters)}
