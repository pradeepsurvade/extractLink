...
def build_sheet2(wb, tcode_data, styles):
...
def build_sheet3(wb, tcode_data, styles):
...
def build_excel(tcode_data: dict, others: list, output_path: str):
    ...
    build_sheet2(wb, tcode_data, shared_styles)
    build_sheet3(wb, tcode_data, shared_styles)
